...
from UAMBlock import UAMBlock

class InclineConvNet(nn.Module):

	def __init__(self):
		super(InclineConvNet, self).__init__()
		...
		self.SeBlock1 = UAMBlock(64, 16, gamma = 2, b = 1)
		self.SeBlock2 = UAMBlock(64, 16, gamma = 2, b = 1)
		self.SeBlock3 = UAMBlock(128, 16, gamma = 2, b = 1)
		self.SeBlock4 = UAMBlock(128, 16, gamma = 2, b = 1)
		self.SeBlock5 = UAMBlock(256, 16, gamma = 2, b = 1)
		self.SeBlock6 = UAMBlock(256, 16, gamma = 2, b = 1)
		self.SeBlock7 = UAMBlock(512, 16, gamma = 2, b = 1)
		self.SeBlock8 = UAMBlock(512, 16, gamma = 2, b = 1)
