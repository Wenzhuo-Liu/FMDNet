...
class Mydata(Dataset):
    def __init__(self,
                 img_path='/root/autodl-tmp/motor_dataset/train/image',
                 txt_path='/root/autodl-tmp/motor_dataset/train/txt',
                 label_path='/root/autodl-tmp/motor/train.txt'):
    ...
    def __getitem__(self, idx):
        ...
        return image, whole_spectrogram, torch.LongTensor(label)
